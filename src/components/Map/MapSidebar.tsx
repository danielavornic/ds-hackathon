    ...
    <div className="flex absolute w-full">
          ...
          >
            <div className="bg-primary text-neutral-content rounded-full w-10">
              <span className="text-xl">
                {/* {(user.user_metadata?.full_name || user.email)?.charAt(0).toUpperCase()} */}D
              </span>
            </div>
          </label>
          <Link
      ...
      >
        ...
        <p
          ...
          contentEditable
        >
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam quod, voluptate, quia,
          voluptates quas voluptatibus quibusdam
        </p>
